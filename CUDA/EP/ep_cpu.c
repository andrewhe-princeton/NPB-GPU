...
for(int32_t i = 0; i < 17;   i = i + 1) {
  ...
  an = t1;
// INSERT COMMENT LOOP: main::for.cond10
...
setup_gpu();
  ...
  __FIXME__agg_2e_tmp18.__FIXME__l_struct_struct_OC_dim3_field0 = threads_per_block;
...
for(int64_t i = 0; i < 10;   i = i + 1) {
  ...
  gc = 0;
// INSERT COMMENT LOOP: main::for.cond47
for(int64_t i = 0; i < 10;   i = i + 1) {
  gc = (gc + _ZL1q[i]);
}
...
c_print_results((_OC_str_OC_54), 65, 29, 0, 0, 0, 0, (__FIXME__call64 / 1.0E+6), (_OC_str_OC_55), verified, (_OC_str_OC_56), (_OC_str_OC_57), (_OC_str_OC_58), (_OC_str_OC_58), (_OC_str_OC_59), (&gpu_device_properties.__FIXME__l_struct_struct_OC_cudaDeviceProp_field0), gpu_config_string, (_OC_str_OC_60), (_OC_str_OC_61), (_OC_str_OC_62), (_OC_str_OC_63), (_OC_str_OC_64), (_OC_str_OC_64), (_OC_str_OC_65));
release_gpu();
  return 0;
}
// MAIN END
